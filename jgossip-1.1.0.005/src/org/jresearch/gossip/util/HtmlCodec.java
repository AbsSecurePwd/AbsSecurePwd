/*
 * $$Id: HtmlCodec.java,v 1.3 2005/06/07 12:32:27 bel70 Exp $$
 *
 * ***** BEGIN LICENSE BLOCK *****
...
public class HtmlCodec {
	 ...
	 * 
	 * @param url
	 *            It is the string to be encoded using the standard
	...
	public static String encodeURL(final String url) {
		try {
			return URLEncoder.encode(url, (String) AccessController
