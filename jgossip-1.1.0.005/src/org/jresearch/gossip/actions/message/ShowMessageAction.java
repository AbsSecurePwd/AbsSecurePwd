/*
 * $$Id: ShowMessageAction.java,v 1.3 2005/06/07 12:31:54 bel70 Exp $$
 *
 * ***** BEGIN LICENSE BLOCK *****
...
public class ShowMessageAction extends BaseAction {
	...
	public ActionForward process(ActionMapping mapping, ActionForm form,
		...
		sb.append(pmForm.getFid());
		sb.append("&tid=");
		sb.append(pmForm.getTid());

		try {

			int block = dao.getMessBlock(user, pmForm);

			if (block == IConst.VALUES.NOT_EXIST) {
				setStatusMessage(request, "messages.NOT_FOUND");
			} else {
				sb.append("&block=");
				sb.append(block);
				sb.append("&#");
