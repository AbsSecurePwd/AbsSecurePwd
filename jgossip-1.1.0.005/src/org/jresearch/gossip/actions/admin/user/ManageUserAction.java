/*
 * $$Id: ManageUserAction.java,v 1.3 2005/06/07 12:31:53 bel70 Exp $$
 *
 * ***** BEGIN LICENSE BLOCK *****
 ...
 * @author Bel
 */
public abstract class ManageUserAction extends BaseAction {
	 ...
	 * @param string
	 */
	public void setUpdatedLogin(String string) {
		updatedLogin = string;
	}
}
