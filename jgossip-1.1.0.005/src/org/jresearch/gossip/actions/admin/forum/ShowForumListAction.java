/*
 * $$Id: ShowForumListAction.java,v 1.3 2005/06/07 12:32:30 bel70 Exp $$
 *
 * ***** BEGIN LICENSE BLOCK *****
 ...
 * @author Bel
 */
public class ShowForumListAction extends BaseAction {
	/**
	 * DOCUMENT ME!
	 * 
	 * @param mapping
	...
	public ActionForward process(ActionMapping mapping, ActionForm form,
		...
		try {
			...
			request.setAttribute(IConst.REQUEST.GROUPS_KEY, forumDAO.getGroups(
					user.getStatus(), true));
