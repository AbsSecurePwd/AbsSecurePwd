...
<tiles:importAttribute/> 
      <table width="98%" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td class="top_tab" nowrap><span class="caption"><fmt:message key="tags.STAGS"/></span>&nbsp;&nbsp;
			</td>
			<td width="70%" >
			</td>
		</tr>
		...
		<tr>
			...
			<td class="r_g" align="center" width="70%">
				&nbsp;&nbsp;&nbsp;
			</td>
		</tr>
	<c:forEach var="item" items="${pageScope.items}" varStatus="status">
		<tr class="strip<c:out value="${status.count%2}"/>">
			<td class="lt_g_txt_b" align="center">&nbsp;
			</td>
			<td class="ltr_g" nowrap colspan="2">	
				<table width="100%" cellspacing="0" cellpadding="0">
			        	<tr>
				        	<td >
		                      &nbsp;<fmt:message key="tags.IF"/> <c:out value="${item}" escapeXml="false"/> - <fmt:message key="tags.WILLGET"/>
		                	</td>
	                		<td class="l_g" width="200">
	                          <div align="center"><gossip:process value="${item}"/></div>
							</td>
			        	</tr>
			        </table>	
			</td>
