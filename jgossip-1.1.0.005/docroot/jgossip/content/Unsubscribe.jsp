...
<gossip:navBar id="<%=IConst.PAGE.TITLE_NAV_BAR%>" >
	<gossip:navElement>
		<gossip:title>
			<fmt:message key="mails.UNSUBSCR"/>
		</gossip:title>
	</gossip:navElement>
</gossip:navBar>
<%@ include file="../jspf/topbar.jspf"%>

   <html:form action="/Unsubscribe"  onsubmit="hideErrors();return validateSubscribeForm(this);">
		...
		<tr>
			...
			<td class="top_tab" nowrap>	&nbsp;&nbsp;<span class="caption_l"><fmt:message key="mails.UNSUBSCR"/></span>&nbsp;&nbsp;
			</td>
			<td>&nbsp;
			</td>
			<td>
		...
		<tr class="drk">
			<td class="lt_g_txt_b" align="center"><fmt:message key="mails.E_EMAIL"/>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;
				  <html:text property="email" size="64"   maxlength="64" />
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
		</tr>
...
<html:javascript formName="subscribeForm" staticJavascript="false"/>
