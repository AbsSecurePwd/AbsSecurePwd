...
<gossip:navBar id="<%=IConst.PAGE.TITLE_NAV_BAR%>" >
	<gossip:navElement>
		<gossip:title>
			<fmt:message key="user.CHANGE_PASS"/>
		</gossip:title>
	</gossip:navElement>
</gossip:navBar>
...
<html:form action="/ChangePassword" onsubmit="hideErrors();return validateChangePasswordForm(this);">
        <table width="98%" cellspacing="0" cellpadding="0">
		<tr>
			<td width="120">	&nbsp;&nbsp;
			</td>
			<td class="top_tab" nowrap>	&nbsp;&nbsp;<span class="caption_l"><fmt:message key="user.CHANGE_PASS"/></span>&nbsp;&nbsp;
			</td>
			<td>&nbsp;
			</td>
			<td>
		...
		<tr class="drk">
			<td class="lt_g_txt_b" align="center"><fmt:message key="forum.U_PASS"/>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:password property="password"  size="18" maxlength="16"
               redisplay="false"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
		...
		<tr class="lght">
			<td class="lt_g_txt_b" align="center"><fmt:message key="user.N_PASS1"/>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:password property="password1"  size="18" maxlength="16"
               redisplay="false"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
		...
		<tr class="drk">
			<td class="lt_g_txt_b" align="center"><fmt:message key="user.N_PASS2"/>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:password property="password2"  size="18" maxlength="16"
               redisplay="false"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
      ...
      <html:javascript formName="changePasswordForm" staticJavascript="false"/>
