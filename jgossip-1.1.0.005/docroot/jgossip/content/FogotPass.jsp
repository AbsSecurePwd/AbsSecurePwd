...
<gossip:navBar id="<%=IConst.PAGE.TITLE_NAV_BAR%>" >
	<gossip:navElement>
		<gossip:title>
			<fmt:message key="global.FORGOTPASS"/>
		</gossip:title>
	</gossip:navElement>
</gossip:navBar>
...
<html:form action="/FogotPass" onsubmit="hideErrors();return validateFogotPassForm(this);">
<html:hidden property="uid" value='<%=request.getParameter("uid")%>'/>
		...
		<tr>
			...
			<td class="top_tab" nowrap>	&nbsp;&nbsp;<span class="caption_l"><fmt:message key="global.FORGOTPASS"/></span>&nbsp;&nbsp;
			</td>
			<td width="70%">&nbsp;
			</td>
			<td>
		...
		<tr class="drk">
			<td class="lt_g_txt_b" align="left"><fmt:message key="user.PLEASEEEM"/><br><fmt:message key="user.PLEASEEEM2"/><br><br>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:text property="email" maxlength="255"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
		</tr>
      ...
      <html:javascript formName="fogotPassForm" staticJavascript="false"/>
