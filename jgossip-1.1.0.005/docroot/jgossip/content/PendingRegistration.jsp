...
<html:form action='/PendingRegistration' onsubmit="hideErrors();return validatePendingRegistrationForm(this);">
	<input type="hidden" value="pending" name="dispatch">
...
<html:javascript formName="pendingRegistrationForm" staticJavascript="false"/>
