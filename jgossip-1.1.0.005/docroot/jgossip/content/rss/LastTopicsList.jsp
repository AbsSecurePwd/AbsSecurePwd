...
<rss version="2.0">
    <channel>
        <title>
            <gossip:codec><gossip:config key="<%=IConst.CONFIG.SITE_NAME%>"/></gossip:codec>
        </title>
        <link>
            http://<c:out value="${requestScope.JRF_SITE_URL}"/>Main.do
        </link>
        <image>
        ...
        <description>
            <gossip:codec><gossip:config key="<%=IConst.CONFIG.MOTTO%>"/></gossip:codec>
        </description>
        <lastBuildDate>
            ...
            <c:forEach var="thread" items="${requestScope.JRF_RECORDS_DATA}">
                <item>
                   ...
                   <link>
                    ...
                    <category>
                        <gossip:codec value="${thread.forumName}"/>
                    </category>    
                </item>
            </c:forEach>
    </channel>
