...
<gossip:navBar id="<%=IConst.PAGE.TITLE_NAV_BAR%>" >
	<gossip:navElement>
		<gossip:title>
			<fmt:message key="constants.MAILPASSWORD"/>
		</gossip:title>
	</gossip:navElement>
</gossip:navBar>
...
<html:form action="/SetMailPassword" onsubmit="hideErrors();return validateMailPasswordForm(this);">
        <table width="98%" cellspacing="0" cellpadding="0">
		<tr>
			<td width="120">	&nbsp;&nbsp;
			</td>
			<td class="top_tab" nowrap>	&nbsp;&nbsp;<span class="caption_l"><fmt:message key="constants.MAILPASSWORD"/></span>&nbsp;&nbsp;
			</td>
			<td>&nbsp;
			</td>
			<td>
		...
		<tr class="lght">
			<td class="lt_g_txt_b" align="center"><fmt:message key="user.PASS1"/>
			</td>
		...
		<tr class="drk">
			<td class="lt_g_txt_b" align="center"><fmt:message key="user.PASS2"/>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:password property="passwordConfirm"  size="18" maxlength="16"
               redisplay="false"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
      ...
      <html:javascript formName="mailPasswordForm" staticJavascript="false"/>
