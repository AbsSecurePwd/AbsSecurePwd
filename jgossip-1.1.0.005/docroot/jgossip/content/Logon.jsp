...
<gossip:navBar id="<%=IConst.PAGE.TITLE_NAV_BAR%>" >
	<gossip:navElement>
		<gossip:title>
			<fmt:message key="forum.LOG_TIT"/>
		</gossip:title>
	</gossip:navElement>
</gossip:navBar>
<%@ include file="../jspf/topbar.jspf"%>

<html:form action="/Logon" onsubmit="hideErrors();return validateLogonForm(this);">
	<html:hidden property="redirectUri" value='<%=(String)request.getAttribute(IConst.REQUEST.REDIRECT_URL)%>'/>
        
        <table width="98%" cellspacing="0" cellpadding="0">
		<tr>
			<td width="120">	&nbsp;&nbsp;
			</td>
			<td class="top_tab" nowrap>	&nbsp;&nbsp;<span class="caption_l"><fmt:message key="forum.LOG_TIT"/></span>&nbsp;&nbsp;
			</td>
			<td>&nbsp;
			</td>
			<td>
		...
		<tr class="drk">
			<td class="lt_g_txt_b" align="center"><fmt:message key="forum.U_NAME"/>
			</td>
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:text property="username" size="18" maxlength="16"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
		</tr>
		<tr class="lght">
			...
			<td class="tl_g" colspan="2">&nbsp;&nbsp;<html:password property="password"  size="18" maxlength="16" redisplay="false"/>
			</td>
			<td class="lr_g_w" >&nbsp;	
			</td>
		</tr>	
...
<html:javascript formName="logonForm" staticJavascript="false"/>
