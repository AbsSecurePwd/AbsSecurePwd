...
public class ProfileManagerPortlet extends ActionPortlet {
    ...
    private PasswordManagerServiceImpl passwordManagerService = new PasswordManagerServiceImpl();
    ...
    public void doSavePass(ActionFormEvent event) {
        ...
        String pass = event.getPasswordBean("origPassword").getValue();
        String passwordValue = event.getPasswordBean("password").getValue();
        String origPasswd = pass;
        ...
        try {
        	...
        	if (req.getAttribute("javax.servlet.request.X509Certificate") == null)
        		new PasswordManagerServiceImpl().validateSuppliedPassword(user, origPasswd);
