...
import org.gridsphere.services.core.security.auth.modules.impl.PasswordAuthModule;
...
*/
	...
	throws AuthenticationException, AuthorizationException {
		...
		//while (it.hasNext()) {
			success = false;
			PasswordAuthModule mod = new PasswordAuthModule(null);
			//= (LoginAuthModule) it.next();
