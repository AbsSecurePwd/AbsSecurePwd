 ...
 * the visibility of this class is reduces to package. the only public class is
 * ForumFacadeClient.
 * 
 * @author $author$
...
public class ForumThreadClient extends ForumBaseClient {
	...
	/**
	 * business client method wich call the DAO layer to create a new
	 * ForumThread.
	 * 
	 * @param ForumThread
	 *            ft the new ForumThread to fill, created by the ForumThread
	 *            Action
	 * @return boolean
	 */
	...
	/**
	 * business client method wich call the DAO layer to retrieve a ForumThread
	 * object filled.
	 *
	 * @param String
	 *            forumThreadID
