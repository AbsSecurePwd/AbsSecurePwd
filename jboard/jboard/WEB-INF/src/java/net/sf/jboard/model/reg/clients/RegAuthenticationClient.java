...
public class RegAuthenticationClient extends RegBaseClient {
	...
	/**
	 * @return authentification state. true if the user has been authenticated
	 *         succesfully.
	 */
	public LoginContext authenticate(String username, String password) {

		try {
			// if we want to have a subject with special credentials (public and
			// private)
	...
	/**
	 * register the User Object which handle registration parameters like
	 * pseudonyl, icq identification number etc...
	 * 
	 * @param user
