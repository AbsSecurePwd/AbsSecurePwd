...
/**
 * <strong>unique</strong> EntryPoint of the Forum Business part. it regroups
 * all the business Forum uses case in one location to reduce couplage between
 * the presentation and the business tiers. it is the implementation of the
 * <strong>facade</strong> design pattern. it is the only
 * <strong>public</strong>class in this package to reduce couplage with the
 * presentation tiers.
 * 
...
public class ForumFacadeClient implements ForumFacadeInterface {
	...
	/**
	 * constructor. this constructor is <i>protected</i>, because it can be
	 * called only by her factory.
	 *
	 */
