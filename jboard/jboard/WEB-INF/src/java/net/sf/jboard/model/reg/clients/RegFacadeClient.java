 ...
 * all the business Registration uses case in one location to reduce couplage
 * between the presentation and the business tiers. it is the implementation of
 * the <strong>facade</strong> design pattern. it is the only
