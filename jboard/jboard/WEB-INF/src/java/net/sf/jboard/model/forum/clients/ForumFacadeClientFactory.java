...
public class ForumFacadeClientFactory {
	...
	public static ForumFacadeInterface getForumFacadeClient() {
		...
		// ForumFacadeInvocationHandler ffih = new
		// ForumFacadeInvocationHandler(new ForumFacadeClient());
		/*
		 * ForumFacadeInterface ffi = (ForumFacadeInterface)
		 * Proxy.newProxyInstance(ForumFacadeClient.class.getClassLoader(), new
		 * Class[] { ForumFacadeInterface.class }, ffih);
		 */
