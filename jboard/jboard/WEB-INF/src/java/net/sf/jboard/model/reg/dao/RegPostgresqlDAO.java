...
public class RegPostgresqlDAO implements RegDAOInterface {
	...
	/**
	 * authentication datasource name. this datasource and the forumDatasource
	 * can be different. one to authenticate the user (a centralized enterprise
	 * datasource which is common to all the enterprise applications), and the
	 * forumDatasource which concerns only our forum application.
	 */
	 ...
	 * 
	 * @param User
	 * @return result. true if a user with the same name exists, false
	 *         otherwise.
	 */
	 ...
	 * 
	 * @see net.sf.jboard.model.reg.dao.RegDAOInterface#addNecessaryUserAndRole(java.lang.String,
	 *      java.lang.String, java.lang.String)
	 * @param databaseSettings
	 * @param list
	 *            which contains user, password, and role to create
	 */
	public void addNecessaryUsersAndRoles(List list) throws DAOException {
		...
		while (it.hasNext()) {
			...
			try {
				...
				pst = con
						.prepareStatement(" SELECT userid FROM " + userTable + " where username = ? and  password =? ");
				...
				if (!rsu.next()) {
					pst = con.prepareStatement(" INSERT INTO " + userTable
							+ " (userid,username,password) VALUES(nextval('User_seq'), ? , ? )");
				...
				if (!rsu.next()) {
					...
					pst = con.prepareStatement(
							" INSERT INTO " + roleTable + " (roleid,rolename) VALUES( nextval('Role_seq') , ? )");
					pst.setString(1, role);
					result = pst.executeUpdate();
				...
				if (!rsu.next()) {
					...
					pst = con.prepareStatement(" INSERT INTO " + roleMapTable + " (userid,roleid) VALUES( "
	...
	public Set retrieveUserRoles(long userId) throws DAOException {
		...
		try {
			...
			ps = con.prepareStatement("SELECT " + roleTable + ".RoleName FROM " + roleMapTable + "," + roleTable
	...
	/**
	 * set the map which contains the datasourceSettings like roletable name and
	 * so on...
	 * 
	...
	public boolean register(User user) throws DAOException {
		...
		forumUsersRequest.append(
				" ForumUsers(pseudonym,password,firstName,lastName,icq,aim,msn,yahoo,webSite,localisation,job,hobbies,signature) ");
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#setSession(net.sf.hibernate.
	 * Session)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#addUser(net.sf.jboard.model.
	 * reg.dto.User)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#addRole(net.sf.jboard.model.
	 * reg.dto.Role)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#roleAlreadyExists(net.sf.
	 * jboard.model.reg.dto.Role)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#getRole(java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#addRoleToUser(net.sf.jboard.
	 * model.reg.dto.User, java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#getUser(java.lang.String)
	 */
