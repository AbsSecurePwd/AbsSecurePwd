...
public final class Constants implements Serializable {
	...
	/**
	 * Request scope attribute key under which the {@link VoteForm} form bean is
	 * kept.
	 */
	...
	/**
	 * The resource key identifier for the attribute under which the transaction
	 * control token messages are kept.
	 */
