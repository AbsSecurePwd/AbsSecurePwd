...
public class DBViaJNDILogin extends SimpleLogin {
	 ...
	 */
	public synchronized Vector validateUser(String username, String pass) throws LoginException {
		String pass1 = pass;
	...
	/**
	 * intialize admin login & password if the tables are empty (first
	 * initialisation).
	 * 
	 * @param login
	 * @param password
	...
	@Override
	protected Vector validateUser(String arg0, char[] arg1) throws LoginException {
