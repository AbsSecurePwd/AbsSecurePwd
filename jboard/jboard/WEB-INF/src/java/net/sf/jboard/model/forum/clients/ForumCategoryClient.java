...
/**
 * the ForumCategory client which interact with the DAO layer to act on the DATA
 * layer. the visibility of this class is reduces to package. the only public
 * class is ForumFacadeClient.
 * 
