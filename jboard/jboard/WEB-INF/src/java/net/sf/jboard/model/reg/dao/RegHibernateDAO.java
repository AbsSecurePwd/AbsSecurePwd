...
public class RegHibernateDAO implements RegDAOInterface {
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#setAuthDatasourceName(java.
	 * lang.String)
	 */
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#setForumDatasourceName(java.
	 * lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see net.sf.jboard.model.reg.dao.RegDAOInterface#
	 * setAuthenticationDatasourceSettings(java.util.Map)
	 */
	...
	public Map validateUser(String userName) throws DAOException {
		...
		try {
			session = RegHibernateUtil.currentSession();
			List users = session.find(" from net.sf.jboard.model.reg.dto.User as user where user.userName=? ", userName,
					Hibernate.STRING);
			;
			userMap = new HashMap();
	 ...
	 * 
	 * @see
	 * net.sf.jboard.model.reg.dao.RegDAOInterface#register(net.sf.jboard.model.
	 * reg.dto.User)
	 */
	...
	public Role getRole(String name) throws DAOException {
		...
		try {
			session = RegHibernateUtil.currentSession();
			results = (List) session.find(" from net.sf.jboard.model.reg.dto.Role role where role.roleName = ? ", name,
					Hibernate.STRING);
	...
	public User getUser(String userName) throws DAOException {
		...
		try {
			session = RegHibernateUtil.currentSession();
			results = session.find(" from net.sf.jboard.model.reg.dto.User user where user.userName = ? ", userName,
					Hibernate.STRING);
			session.flush();
		} catch (HibernateException e) {
			// TODO Auto-generated catch block
