 ...
 *         this class was inspired by the article on jaas published at
		...
		try {
			Subject.doAsPrivileged(subj, new PrivilegedExceptionAction() {
				public Object run() {
					...
					// the 'null' tells the SecurityManager to consider this
					// resource access
					// in an isolated context, ignoring the permissions of code
					// currently
