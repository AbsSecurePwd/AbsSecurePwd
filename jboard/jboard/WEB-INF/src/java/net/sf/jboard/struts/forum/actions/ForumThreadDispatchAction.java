...
public class ForumThreadDispatchAction extends DispatchAction implements ConstantsContext, ConstantsMessages {
	...
	public ActionForward create(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws ViewException, ClientException {
	...
	/**
	 * call the business client to retrieve from the DAO abstraction, the
	 * <code>ForumThread</code> item.
	 *
	 * @param mapping
	 * @param form
	 * @param request
	 ...
	 * @throws ViewException
	 */
	public ActionForward beforeUpdate(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) throws ViewException {
